...
<body>
    ...
    <main>
        ...
        <section class="contact-section">
            <div class="container">
                <h2 class="contact-title">Aproape de tine!</h2>
                <div class="iframe" style="text-align: left;">
                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d5607.074822614412!2d24.656754697701583!3d47.05921893989489!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zNDfCsDAzJzM0LjAiTiAyNMKwMzknMjQuOSJF!5e0!3m2!1sro!2sro!4v1616692865923!5m2!1sro!2sro" width="1250" height="450" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
                </div>
                <div class="row">
                    <div class="col-12">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group">
                                        <textarea class="form-control w-100" name="message" id="message" cols="30" rows="9" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter Message'" placeholder=" Introduceți mesajul"></textarea>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                    ...
                    <div class="col-lg-3 offset-lg-1">
                        <div class="media contact-info">
                            ...
                            <div class="media-body">
                                <h3>Budacu de Sus, Bistrița-Năsăud.</h3>
                                <p>Principală, nr 279</p>
                            </div>
                        </div>
                        <div class="media contact-info">
                            ...
                            <div class="media-body">
                                ...
                                <p>Luni -Duminica --> 8am spre 6pm</p>
                            </div>
                        </div>
                        <div class="media contact-info">
                            <span class="contact-info__icon"><i class="ti-email"></i></span>
                            <div class="media-body">
                                <h3>autobudac@gmail.com</h3>
                                <p>Intreabă-ne orice, oricând!</p>
                            </div>
                        </div>
                    </div>
                </div>
